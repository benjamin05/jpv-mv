...
class SendFaxDialog extends JDialog{
    ...
    SendFaxDialog(Component parent, Rx receta, Integer idCliente, Integer idSucursal, String titulo, String uso, Boolean edit, Boolean obligatory, String idOrder) {
        sb = new SwingBuilder()
        component = parent
        itemUso = uso
        rec = null
    ...
    void buildUI() {
        sb.dialog(this,
            ...
            empleadoPanel = panel(visible: false, constraints: 'hidemode 3', layout: new MigLayout('fill,wrap 3, left', '[fill][fill][fill,grow,left]'), maximumSize: [600, 200]) {
                label(text: 'Uso:')
            ...
            panel(layout: new MigLayout('wrap 3,right', '[right][right]')) {
                ...
                button(text: 'Enviar Fax', actionPerformed: { doRxSave() }, maximumSize: [110, 90])
    ...
    private void useGlasess() {
        ...
        OrderController.saveJbTrackFax( idOrder )
        OrderController.saveAcuseFax( idOrder )
        doCancel()
    }
