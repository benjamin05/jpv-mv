...
import mx.lux.pos.ui.view.panel.EditCustomerPanel
...
class EditCustomerDialog extends JDialog {
    ...
    public EditCustomerPanel custPanel
    ...
    EditCustomerDialog( Component parent, Customer customer, boolean editar ) {
        component = parent
        cliente = customer
        edit = editar

        this.custPanel = new EditCustomerPanel( this, this.cliente, this.edit )
