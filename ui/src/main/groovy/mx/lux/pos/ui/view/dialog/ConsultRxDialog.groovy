...
class ConsultRxDialog extends JDialog{
    ...
    ConsultRxDialog(Rx receta, Boolean edit) {
        sb = new SwingBuilder()
        component = parent
        //itemUso = uso
        rec = null
        ...
        sb.dialog(this,
            ...
            panel(border: titledBorder("Rx"), layout: new MigLayout('fill,wrap ,center', '[fill,grow]')) {
                panel(layout: new MigLayout('fill,wrap 8,center',
                    ...
                    txtOdAd = textField(toolTipText: 'Adición', horizontalAlignment: JTextField.RIGHT, visible: mostrarParametroP, enabled: false)
                    ...
                    txtOdDm = textField(toolTipText: 'Distancia Monocular', horizontalAlignment: JTextField.RIGHT, visible: (mostrarParametroP && mostrarParametroB), enabled: false)
                    ...
                    txtDILejos = textField(minimumSize: [20, 20], toolTipText: 'Distancia Interpupilar Binocular', horizontalAlignment: JTextField.RIGHT,
                            visible: (mostrarParametroP && !mostrarParametroB) || mostrarParametroSV, enabled: false)
                    ...
                    txtOiAd = textField(toolTipText: 'Adición', horizontalAlignment: JTextField.RIGHT, visible: mostrarParametroP, enabled: false)
                    ...
                    txtOiDm = textField(toolTipText: 'Distancia Monocular', horizontalAlignment: JTextField.RIGHT,
                            visible: (mostrarParametroP && mostrarParametroB), enabled: false)
                    ...
                    txtAltOblea = textField(minimumSize: [20, 20], toolTipText: 'Altura Segmento', horizontalAlignment: JTextField.RIGHT,
                            visible: mostrarParametroP, enabled: false)
            ...
            panel(layout: new MigLayout('wrap 3,right', '[right][right]')) {
                ...
                //button(text: 'Guardar', actionPerformed: { doRxSave() }, maximumSize: [110, 90])
                button(text: 'Cerrar', actionPerformed: { doCancel() }, maximumSize: [110, 90])
            }
        }
    }
    ...
    /*private void doRxSave() {
      if ( dataRxValid && validDataRx() ) {
        if(doOptSearch()){
          ...
          } else if (useGlass.equals(usoP[0])) {
                    useGlass = 'PROGRESIVO'
          ...
          } else if (useGlass.equals(usoM[0]) || useGlass.equals(usoM[1])) {
                    useGlass = 'MONOFOCAL'
