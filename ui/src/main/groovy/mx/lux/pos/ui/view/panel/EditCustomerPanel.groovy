...
import mx.lux.pos.ui.view.dialog.CustomerSearchOrderServiceDialog
import mx.lux.pos.ui.view.dialog.EditCustomerDialog
...
class EditCustomerPanel extends JPanel {
    ...
    private EditCustomerDialog CustomerAndDialog = null
    ...
    EditCustomerPanel(Component parent, Customer customer, boolean editar) {
        CustomerAndDialog = parent as EditCustomerDialog
        edit = editar
