...
public class Empleado implements Serializable {
    ...
    public String getNombre() {
        return StringUtils.trimToEmpty( nombre );
    }
    ...
    public String getApellidoPaterno() {
        return StringUtils.trimToEmpty( apellidoPaterno );
    }
    ...
    public String getApellidoMaterno() {
        return StringUtils.trimToEmpty( apellidoMaterno );
    }
    ...
    public String getPasswd() {
        return StringUtils.trimToEmpty( passwd );
    }
    ...
    public String getIdModificado() {
        return StringUtils.trimToEmpty( idModificado );
    }
