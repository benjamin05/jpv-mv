...
import mx.lux.pos.service.business.PromotionQuery
import org.apache.commons.lang3.StringUtils
import org.apache.commons.lang3.math.NumberUtils

class PromotionEngineJava {

  // Singleton
  static PromotionEngineJava instance = new PromotionEngineJava()

  private PromotionEngineJava( ) { }
  ...
  Boolean cancelPromotion( PromotionModel pModel, PromotionAvailable pPromotion, Boolean pUserSelection ) {
    ...
    if ( result ) {
      PromotionCommitJava.writeOrder( pModel )
    }
    return result
  }
